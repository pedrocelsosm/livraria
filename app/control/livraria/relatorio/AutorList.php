...
class AutorList extends TPage
{
    ...
    public function __construct()
    {
        ...
        // creates the form
        $this->form = new BootstrapFormBuilder('form_search_Autor');
        ...
        $this->form->addActionLink('New', new TAction(['AutorFormList', 'onEdit']), 'fa:plus green');
        ...
        $action1 = new TDataGridAction(['AutorFormList', 'onEdit'], ['id'=>'{id}']);
